...
As the sample increases the standard deviation gets smaller while the mean stays the same. With numb=4 the mean = `r mean(my1000$k4)`  sd =  `r sd(my1000$k4)` which is close to 21 meaning it makes sense.
...
As the sample increases the standard deviation gets smaller while the mean stays the same. With numb=9, mean =  49.6287777777778 and sd =  14.1762847742495 which is close to 14 meaning it makes sense.
...
As the sample increases the standard deviation gets smaller while the mean stays the same. With numb=16, mean =  50.08925,  sd =  10.6839581920817 which is close to 10.5 meaning it makes sense.
...
As the sample increases the standard deviation gets smaller while the mean stays the same. With numb=25, mean =  49.76856 and sd =  8.37776782443391 which is close to 8.4 meaning it makes sense.
...
As the sample increases the standard deviation gets smaller while the mean stays the same. With numb=36, mean =  49.8618611111111 and sd =  6.8713746858436 which is close to 6 meaning it makes sense.