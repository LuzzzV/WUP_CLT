...
As the sample increases the standard deviation gets smaller while the mean stays the same. With numb=4 the mean =  49.515  sd =  19.9392884834245 which is close to 21 meaning it makes sense.
